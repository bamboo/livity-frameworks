...
namespace Livity.Composition.Primitives
{
	...
	{
		public static IEnumerable<ImportDefinition> ImportsOf(Type type)
		{
			return type
				.Hierarchy()
				.SelectMany(_ => _.InstanceMembers())
	...
	internal class ImportDefinitionBuilder
	{
		...
		public ImportDefinitionBuilder(ImportAttribute import, Type actualType, Action<object, object> setter)
		{
			...
			_setter = setter;
			_elementType = ElementTypeOf(_actualType);
		...
		private Type ElementTypeOf(Type importType)
		{
